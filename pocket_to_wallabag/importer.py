...
def main():
    ...
    # 3 - redirect user
    webbrowser.open(
        f"https://getpocket.com/auth/authorize?request_token={POCKET_REQUEST_TOKEN}&redirect_uri={REDIRECT_URI}",
        new=2,
    )
    print(
        f"if your browser did not open, please go to : https://getpocket.com/auth/authorize?request_token={POCKET_REQUEST_TOKEN}&redirect_uri={REDIRECT_URI}"
    )
